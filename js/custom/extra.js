...
(function () {
    ...
    function controlName() {
        ...
        if (myName.value.length == 0) {
            ...
            return false;
        } else if (myName.value.length < 4) {
            myName.classList.remove("is-valid");
            myName.classList.add("is-invalid");
            myError.innerHTML = "İsiminiz 4 karakterden az olamaz";
            return false;
        } else if (myName.value.length > 30) {
            myName.classList.remove("is-valid");
            myName.classList.add("is-invalid");
            myError.innerHTML = "İsiminiz 30 karakterden fazla olamaz";
            return false;
        } else if (!spacePattern.test(myName.value)) {
            myName.classList.remove("is-valid");
            myName.classList.add("is-invalid");
            myError.innerHTML = "İsim alanında boşluk bırakılamaz";
            return false;
        } else if (!NumeriPattern.test(myName.value)) {
            myName.classList.remove("is-valid");
            myName.classList.add("is-invalid");
            myError.innerHTML = "İsim alanında rakam kullanılamaz";
            return false;
        }
        else {
    ...
    function controlEmail() {
        ...
        if (myEmail.value.length == 0) {
            ...
            myEmail.classList.remove("is-valid");
            myEmail.classList.add("is-invalid");
            myError.innerHTML = "E-posta alanında boşluk bırakılamaz";
            return false;
        } else if (!EmailPattern.test(myEmail.value)) {
            myEmail.classList.remove("is-valid");
            myEmail.classList.add("is-invalid");
            myError.innerHTML = "E-posta formatınız yanlış";
            return false;
        } else if (myEmail.value.length > 45) {
            myEmail.classList.remove("is-valid");
            myEmail.classList.add("is-invalid");
            myError.innerHTML = "E-posta adresiniz 45 karakterden fazla olamaz";
            return false;
        } else {
    ...
    function controlPhone() {
        ...
        if (myPhone.value.length == 0) {
            ...
            myError.innerHTML = "Lütfen telefon numaranızı giriniz";
            return false;
        } else if (myPhone.value.length < 11) {
            myPhone.classList.remove("is-valid");
            myPhone.classList.add("is-invalid");
            myError.innerHTML = "Telefon numaranız 11 karakterden az olamaz";
            return false;
        } else if (myPhone.value.length > 13) {
            myPhone.classList.remove("is-valid");
            myPhone.classList.add("is-invalid");
            myError.innerHTML = "Telefon numaranız 13 karakterden fazla olamaz";
            return false;
        } else if (!spacePattern.test(myPhone.value)) {
            myPhone.classList.remove("is-valid");
            myPhone.classList.add("is-invalid");
            myError.innerHTML = "Telefon alanında boşluk bırakılamaz";
            return false;
